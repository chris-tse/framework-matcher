...
function Card({ text, flipped, handleCardClick, cardId }: CardProps) {
    ...
    return (
        ...
        >
            <div
                className="bg-white absolute w-full h-full flex flex-col justify-center backface-hidden"
                style={{ transformStyle: 'preserve-3d' }}
            >
                ?
            </div>
            <div
                className="bg-white absolute w-full h-full flex flex-col justify-center p-4 backface-hidden"
